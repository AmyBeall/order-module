...
function Youtubeanalytics(options) { // eslint-disable-line
  ...
  self.reports = {
     ...
     * @param {string} params.metrics A comma-separated list of YouTube Analytics metrics, such as views or lCatering System,dislCatering System. See the Available Reports document for a list of the reports that you can retrieve and the metrics available in each report, and see the Metrics document for definitions of those metrics.
